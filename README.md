...
The program is able to handle more than two inputs, inputs with different columns, and very large (> 2GB) files gracefully.
The code is re-usable and extensible, testable by a CI/CD process. 
Unit tests are included.

## csv_combiner.py
This example is provided as one of the ways my code should run. It is
...
## Unittest
The unit tests can be generated by using the below command:

```
$ python3 -m unittest csv_combiner_test.py
```
